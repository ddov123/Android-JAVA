...
public class DaeguActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar sign_toolbar = findViewById(R.id.daegu_toolbar);
        setSupportActionBar(sign_toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true); // 뒤로가기 버튼, 디폴트로 true만 해도 백버튼이 생김
        getSupportActionBar().setTitle(daegu); // 툴바 제목 설정

        if (FirebaseAuth.getInstance().getCurrentUser() != null) {

            //listview 만들기
            ListView listview = findViewById(R.id.listview);
            adapter = new ArrayAdapter<String>(DaeguActivity.this, R.layout.activity_listitem, fileList);
            ...
            patientRef.orderByChild("pWhere").equalTo(daegu).addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    AlertDialog.Builder alertdialog = new AlertDialog.Builder(DaeguActivity.this);
...
//                            Object vo = parent.getAdapter().getItem(position);
                            ...
                            Toast.makeText(DaeguActivity.this, "간병 제안 요청 및 채팅방을 개설 하였습니다.", Toast.LENGTH_SHORT).show();

                            Intent intent2 = new Intent(DaeguActivity.this, AlertActivity.class);
                    ...
                    alertdialog.setNegativeButton("취소", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int i) {
                            Toast.makeText(DaeguActivity.this, "취소하였습니다.", Toast.LENGTH_SHORT).show();
                        }
                    });
